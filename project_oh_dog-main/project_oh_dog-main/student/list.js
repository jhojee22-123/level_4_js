...
const optResult = document.querySelector('.opt_result');//주문 옵션 선택시
...
//주문옵션 숨기기/보이기 함수
function showHideFunc(target, visible='none'){return target.style.display = visible;}
...
//     let changeOpt = sizeSelect.options[sizeSelect.selectedIndex].text;//선택 옵션 변수 저장
