...
//     popup.style.zIndex = '999'; //css파일에 입력ok
// })
//     noticeFirst.addEventListener('click',()=>{
//         popup.style.display = 'none';
// })
...
//자바스크립트에선 HTML 작업시 변수 저장 작업 필수!
//제이쿼리는 변수 구조가 워낙 짧아 2~3번 이상 자주 반복하는 변수만 지정하고 그외에는 일회성으로 사용가능

$('#popup').hide();

const $sub =$('nav > ul > li > ul');
const $nav =$('nav > ul > li');
//sub.hide(); //제이쿼리는 대상이 2개 이상이어도 for없이 한번에 다수 처리가 가능하다.
...
//제이쿼리 사용시 화살표 함수 사용 권장안함. 일반함수 위주로 사용
// $(this) 현재 마우스 오버 한 대상
