...
//콘솔 1~10 숫자 출력
//for(let i=1; 1<=10; i++) //증감식 옆엔 세미콜론(;) 쓰지않기
for(let i=1; i<11; i++){
...
console.log('------------------------')
//탄생석 12월~1월 출력
const jewelry =['석류석', '자수정', '아쿠아마린', '다이아몬드', '에메랄드', '진주', '루비', '페리도트', '사파이어', '오팔', '황옥', '터키석']
for(let i=12; i>0; i--){
    console.log(`${i}월의 탄생화는 ${jewelry[i-1]}입니다.`)
}
