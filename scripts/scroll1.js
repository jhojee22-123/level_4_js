...
window.addEventListener('scroll', ()=>{
    ...
    for(let s of section){
        ...
        //console.log(sTop); //각 섹션 top 위치값 확인 테스트
    ...
    if(window.scrollY >= 400){ topCTA.classList.add('active');
    }else { topCTA.classList.remove('active'); }

    //스크롤 위치에 따라 Header 디자인 변경하기
    if(window.scrollY >=120){ header.classList.add('active'); 
