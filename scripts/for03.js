...
//for(let 초기변수 in변수에 대입할 대상){반복처리}
for(let f in flower){
    console.log(f); //인덱스 출력 0123
...
//for~of
//for(let 초기변수생성 of 대입할 변수대상){ 반복처리할명령 }
...
tab_title.forEach((o, i)=>{
    ...
    o.addEventListener('click',()=>{
        ...
        //for(let reset of tab_contents){reset.classList.remove('active');} //제목 클래스 비활성화
