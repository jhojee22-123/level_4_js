...
//--------------------------------------------연습(웹은행 150만원 입금)
let webBank= 1500000;
let replaceBank = webBank.toLocaleString('fi-fi');/* 핀란드 국가기호 */

//출력 테스트 콘수
console.log(itemPrice, titleBig, result1p, replaceData);

//실행결과
result1p.textContent = replaceData+'원'; /* input과 비교 */
...
foodTray[1] = '연어'; //스케이크 제거 후 연어 새로 대입
console.log(foodTray[1]); //위 변경 '연어'
...
console.log(num); //(변수가 처음 대입된 값 테스트)
